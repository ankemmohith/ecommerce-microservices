...
public class ApiExceptionHandler {
        ...
        public ResponseEntity<ExceptionMessage> handleInvalidOrderStateException(final InvalidOrderStateException e) {

                log.info("**ApiExceptionHandler controller, handle invalid order state transition*\n");
